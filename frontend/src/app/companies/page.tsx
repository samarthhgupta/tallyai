      ...
      {duplicateSource && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md p-6">
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">Duplicate Company</h2>
            ...
            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Source Company</label>
              <div className="w-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 rounded-md px-3 py-2 text-sm text-gray-700 dark:text-gray-300">
                {duplicateSource.name}
              </div>
            </div>

            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">New Company Name</label>
              <input
                autoFocus
                value={duplicateName}
